                ...
                <>  
                    ...
                    <div className='flex h-full'>
                        ...
                        <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
                            ...
                            <Link to="/buscar" className="inline-flex flex-col items-center justify-center px-5  bg-white  border-e border-gray-200 hover:bg-[#dddddd] dark:hover:bg-gray-800 group dark:border-gray-600">
                                ...
                                <span className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Buscar</span>
                            </Link>
