...
export const Navbar = () => {
  const {  isLoggedIn, onLogout, navigate } = useAuth();
    ...
    return (
        ...
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-repeat   dark:border-gray-600">
                ...
                <>  
                    ...
                    <div className='flex h-full'>
                        ...
                        <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
                            ...
                            <Link to="/publicar" className="inline-flex flex-col items-center justify-center px-5  bg-white  border-e border-gray-200 hover:bg-[#dddddd] dark:hover:bg-gray-800 group dark:border-gray-600">
                            ...
                            <Link to="/perfil" className="inline-flex flex-col items-center justify-center px-5  bg-white  border-e border-gray-200 hover:bg-[#dddddd] dark:hover:bg-gray-800 group dark:border-gray-600">
                        ...
                        <div className="grid h-full max-w-lg grid-cols-1 font-medium">

                            <button onClick={handleLogOut} className="inline-flex flex-col items-center justify-center px-5  bg-white  border-e border-gray-200 hover:bg-[#dddddd] dark:hover:bg-gray-800 group dark:border-gray-600">
                                <svg fill="#000000" height="25px" width="25px" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 384.971 384.971" xmlSpace="preserve"><g id="SVGRepo_bgCarrier" strokeWidth={0} /><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round" /><g id="SVGRepo_iconCarrier"><g><g id="Sign_Out"><path d="M180.455,360.91H24.061V24.061h156.394c6.641,0,12.03-5.39,12.03-12.03s-5.39-12.03-12.03-12.03H12.03 C5.39,0.001,0,5.39,0,12.031V372.94c0,6.641,5.39,12.03,12.03,12.03h168.424c6.641,0,12.03-5.39,12.03-12.03 C192.485,366.299,187.095,360.91,180.455,360.91z" /><path d="M381.481,184.088l-83.009-84.2c-4.704-4.752-12.319-4.74-17.011,0c-4.704,4.74-4.704,12.439,0,17.179l62.558,63.46H96.279 c-6.641,0-12.03,5.438-12.03,12.151c0,6.713,5.39,12.151,12.03,12.151h247.74l-62.558,63.46c-4.704,4.752-4.704,12.439,0,17.179 c4.704,4.752,12.319,4.752,17.011,0l82.997-84.2C386.113,196.588,386.161,188.756,381.481,184.088z" /></g><g /><g /><g /><g /><g /><g /></g></g></svg>
                                <span className="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Cerrar sesión</span>
                            </button>
