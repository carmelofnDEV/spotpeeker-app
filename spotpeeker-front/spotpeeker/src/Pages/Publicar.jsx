      ...
      <div className="flex justify-center items-center  w-[100%] p-5 ">
        <div className="w-1/2 flex flex-col shadow-2xl bg-[#dddddd] p-5 rounded-xl gap-5">
          ...
          >
            ...
            <div className="grid grid-cols-4 gap-3">
              {photos.map((file, index) => (
                <img
                  ...
                  alt={`Foto ${index}`}
                  className="rounded-lg h-full object-cover bg-[#ffffff] mb-10"
                />
              ))}
              ...
              {photos.length < 4 ? (
                <div className=" ">
                  <label
                    ...
                    className="h-full flex flex-col items-center justify-center w-full  border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                  >
            ...
            <input className="px-8 py-2 bg-[#fafafafa] rounded-lg" type="submit" value="Publicar" />
            </div>
          </form>
        </div>
      </div>
