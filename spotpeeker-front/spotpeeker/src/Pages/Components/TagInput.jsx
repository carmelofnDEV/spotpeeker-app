...
export const TagInput = ({setPostTags}) => {
    ...
    const handleAddTag = (e) => {
      ...
      if (inputValue.trim() !== '') {
        setPostTags([...tags, inputValue.trim()])
      ...
      <div>
        ...
        <div> 
            <div className='flex gap-3'>
                ...
                />
                <button className='bg-[#fafafa] py-1 px-2 rounded-md' onClick={handleAddTag}>Añadir</button>
            </div>
